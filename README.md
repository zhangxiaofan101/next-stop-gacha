...
> 选择困难症旅行救星：263 个中国目的地 + 52 条多城联游线路，筛一筛慢慢比，扭一个听天由命，串几站直接出路书。
...
| 🎫 线路卡 | 52 条精选多城串线（河西走廊 / 滇藏线 / 大湾区……）与城市卡同池筛选和扭蛋，可整条装进行程单 |
...
263 个目的地按六个文件分区存放在 [`data/`](data/)，另有 52 条多城联游线路：
...
| `data-d.json` | 西北 | 33 |
| `data-e.json` | 华中 + 华南 + 港澳 | 54 |
| `data-f.json` | 西南 | 44 |
| `routes.json` | 多城联游线路卡 | 52 |
