...
export const ICONS = {
  ...
  /* 心形：收藏（M59 ⑤，替换 cards.ts 里的 ♥ 字符，与对比/行程同族线形；激活态仍靠 .on 变红，不填色） */
  heart: svg('<path d="M12 19.5s-7-4.35-9.3-8.8C1.2 7.7 2.8 4.8 5.8 4.3c1.9-.3 3.7.6 4.9 2.3l1.3 1.8 1.3-1.8c1.2-1.7 3-2.6 4.9-2.3 3 .5 4.6 3.4 3.1 6.4-2.3 4.45-9.3 8.8-9.3 8.8Z"/>'),
};
